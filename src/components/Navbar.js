 		...
 		<nav className='navbar__container'>
 		    ...
 		    <div className='navbar__link-wrapper'>
 		    	<ul className='links'>
 		    		...
 		    		<li className='navbar__link-item'>
 		    			<Link to='/' className='link-item'>Cart</Link>
 		    		</li>
 		    		<li className='navbar__link-item'>
 		    		...
 		    		toggleMenu && (
 		    		    <div className='navbar-wrapper-small'>
		 		    	    ...
		 		    	    <ul className='links-small'>
			 		    		<li className='navbar__link-item'>
			 		    			<Link to='/home' className='link-item' onClick={()=>setToggleMenu(false)}>Home</Link>
			 		    		</li>
			 		    		<li className='navbar__link-item'>
			 		    			<Link to='/' className='link-item' onClick={()=>setToggleMenu(false)}>Cart</Link>
			 		    		</li>
			 		    		<li className='navbar__link-item'>
